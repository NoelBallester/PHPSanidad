...
// Detail panel - missing variables
const muestraOrgano = document.getElementById("tubo__organo");
const muestraCaracteristicas = document.getElementById("tubo__caracteristicas");
const muestraTincionDisplay = document.getElementById("tubo__tincion");

// Informe médico fields
const muestraInformeDescripcion = document.getElementById("tubo__informe_descripcion");
const muestraInformeFecha = document.getElementById("tubo__informe_fecha");
const muestraInformeTincion = document.getElementById("tubo__informe_tincion");
const muestraInformeObservaciones = document.getElementById("tubo__informe_observaciones");
const muestraInformeImagen = document.getElementById("tubo__informe_imagen");
