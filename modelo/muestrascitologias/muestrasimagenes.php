...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   if ($accion == "crearMuestra") {
      ...
      $citologiaIdCitologia = $_POST['citologiaIdCitologia'];
      $imagen = $_FILES['imagen'];
      $res =  $muestra->crearMuestra($descripcion,  $fecha,  $observaciones, $tincion,  $citologiaIdCitologia);
   ...
   // Añadir una imagen a una muestra
